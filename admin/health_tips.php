...
<form action="health_tips.php" method="post" enctype="multipart/form-data">

	<table width="800" align="center">
    
    <tr>
    	<td align="right" bgcolor=""><strong>Tips Title:</strong></td>
        <td><input type="text" name="tips_title" size="60" required/></td>
    </tr>
    ...
    <tr>
        ...
        <td><textarea name="tips_description" rows="15" cols="50" required> </textarea></td>
    </tr>
