...
border-right:1px solid #ffcccc; border-radius:40px;">
 ...
 <div class="col-md-6"><center><img src="../images/br.png" style="margin-top:80px;"></center></div>

 
 <div class="col-md-6">
    <div>
      <h2 class="form_title">Patient &nbsp;&nbsp;Login</h2>
    </div>
    ...
    <tr>
      ...
      <td>
       <div id="email_form" style="align:center;">
        <input type="email" name="email" id="email" value="" class="input_email" required>
      </div></td>
    </tr>
    <tr>
