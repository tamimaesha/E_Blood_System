...
border-right:1px solid #ffcccc; border-radius:40px;">
 ...
 <div class="col-md-8">
    <div>
      <h2 class="form_title">Donor &nbsp;&nbsp;Registration &nbsp;&nbsp;Form </h2>
    </div>
...
<form id="form1" name="form1" method="post" action="register.php">
  <table class="tbl_form" width="461" height="431">
	...
	<tr>
      ...
      <td class="field">:</td>
      <td colspan="2">
        <input type="text" name="email" id="textfield4" placeholder="Email Will Be Your Login ID" style="width:300px; height:40px;" required/>
            </td>
    </tr>
    ...
    <tr>
      ...
      <td class="field">:</td>
      <td colspan="2">
	  <select name="blood_group" size="1" id="select" style="width:300px; height:40px;" required>
          <option value="">- - Select - -</option>
